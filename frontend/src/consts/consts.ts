export const API_PREFIX = import.meta.env.VITE_API_URL || 'http://localhost:8043/'
export const API_URL = `${API_PREFIX}api/v1/k8s`;
export const API_URL_AUTH = `${API_PREFIX}api/v1/auth`;
export const KEYCLOAK_URL = import.meta.env.KEYCLOAK_URL || 'http://localhost:8085/'
